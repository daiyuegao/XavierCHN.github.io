		...
		"Modifiers"
		{
			"modifier_book_auto_applier"//自动吃书的Modifier
			{
				...
				"OnCreated"
				{
					...
					"ApplyModifier"
					{
						"ModifierName"			"modifier_warden_book_of_str_bonus"//增加增加力量的状态
						"Target"			      "CASTER"
					}
					...
					{
						"Target"				    "CASTER"
						"ModifierName"			"modifier_book_auto_applier"//为保证安全，手动添加一个移除modifier
			...
			"modifier_warden_book_of_str_bonus"//力量的状态
			{
				...
				"Properties"
				{
					"MODIFIER_PROPERTY_STATS_STRENGTH_BONUS"	"%bonus_str"//增加力量和增加的力量数值
				}
			}
		}
		"AbilitySpecial"
